...
class CreateGenre(BaseTemplatePageMixin, PermissionRequiredMixin, LoginRequiredMixin,generic.CreateView):
...
class UpdateGenre(BaseTemplatePageMixin, PermissionRequiredMixin, LoginRequiredMixin,generic.UpdateView):
    model = models.BookGenre
    form_class = forms.GenreForm
...
class ShowGenre(BaseTemplatePageMixin, PermissionRequiredMixin, LoginRequiredMixin,generic.DetailView):
    model = models.BookGenre
    permission_required = ("book_reference.view_book_genre")
    login_url = reverse_lazy('login')
    template_name = 'book_reference/detail_genre.html'

class ShowGenres(BaseTemplatePageMixin, PermissionRequiredMixin, LoginRequiredMixin, generic.ListView):
    model = models.BookGenre
    permission_required = ("book_reference.view_book_genre")
    login_url = reverse_lazy('login')
    template_name = 'book_reference/list_genres.html'

class DeleteGenre(BaseTemplatePageMixin, PermissionRequiredMixin, LoginRequiredMixin,generic.DeleteView):
    model = models.BookGenre
...
class CreateAuthor(BaseTemplatePageMixin, PermissionRequiredMixin, LoginRequiredMixin,generic.CreateView):
...
class UpdateAuthor(BaseTemplatePageMixin, PermissionRequiredMixin, LoginRequiredMixin,generic.UpdateView):
    model = models.BookAuthor
    form_class = forms.AuthorForm
...
class ShowAuthor(BaseTemplatePageMixin, PermissionRequiredMixin, LoginRequiredMixin,generic.DetailView):
    model = models.BookAuthor
    permission_required = ("book_reference.view_book_author")
    login_url = reverse_lazy('login')
    template_name = 'book_reference/detail_author.html'

class ShowAuthors(BaseTemplatePageMixin, PermissionRequiredMixin, LoginRequiredMixin,generic.ListView):
    model = models.BookAuthor
    permission_required = ("book_reference.view_book_author")
    login_url = reverse_lazy('login')
    template_name = 'book_reference/list_authors.html'

class DeleteAuthor(BaseTemplatePageMixin, PermissionRequiredMixin, LoginRequiredMixin,generic.DeleteView):
    model = models.BookAuthor
